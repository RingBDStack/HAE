...
check_file = 'DBLP/compairGCNGCN/premodel/'
...
alllabel = np.load('DBLP/compairGCNGCN/one_hot_labels.npy')
train_data = np.load('DBLP/compairGCNGCN/train_idx.npy')
test_data = np.load('DBLP/compairGCNGCN/test_idx.npy')
...
if __name__ == "__main__":
    ...
    xdata = np.load("DBLP/compairGCNGCN/features.npy")
    #xdata = preprocess_features_v1(xdata)

    adj_data = np.load("DBLP/compairGCNGCN/small_adj_data.npy")
    with tf.Session() as sess:
        ...
        for epoch in range(epoch_num):
            ...
            with open('DBLP/compairGCNGCN/premodel/output.txt', 'a+') as fi:
            ...
            if eva_acc > max_acc:
                ...
                np.save('DBLP/compairGCNGCN/premodel/featts.npy', featts)
